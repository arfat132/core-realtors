...
const NotFound = () => {
    ...
    return (
        <div className='text-center mx-auto'>
            ...
            <button className="text-white my-6 bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold uppercase rounded-lg text-sm px-5 py-2.5 text-center" onClick={()=>navigate('/')}>Home</button>
        </div>
    );
};
